// src/components/ArkiveLogo.tsx — flat brand mark (graphite tile + amber "A").
import React from 'react';

export const ArkiveLogo: React.FC<{ size?: number; className?: string }> = ({
  size = 40,
  className = '',
}) => (
  <svg
...
export const ArkiveWordmark: React.FC<{ className?: string }> = ({ className = '' }) => (

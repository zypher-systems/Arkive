...
var userCommands = map[string]command{
	...
	// TODO(security workstream): replace with the real 2FA reset.
	"reset-2fa": {name: "reset-2fa", usage: "<email>", summary: "Disable two-factor auth for an account (not yet available)", run: notYet("user reset-2fa")},
}
